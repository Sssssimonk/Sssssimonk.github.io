---
title: "机器学习笔记 06：评估、验证与模型选择"
date: 2024-07-14 22:30:00
updated: 2024-07-14 22:30:00
categories:
  - 机器学习笔记
tags:
  - 机器学习
...
category_bar: true
---
训练 loss 下降只能说明模型更适合训练数据，不等于模型真的有用。好的评估指标和验证方式决定了最后会选择哪个模型，也决定了这个选择是否可靠。
