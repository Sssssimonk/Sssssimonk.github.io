...
## 3. Continuous batching：请求不是凑齐一批再跑
...
## 4. vLLM 和 PagedAttention：把 KV cache 当内存系统管理
...
## 5. FlashAttention 解决的是 attention kernel 的 IO 问题
...
## 6. DeepSpeed-Inference：模型并行、kernel injection 和量化
...
## 9. Speculative decoding：用小模型帮大模型起草
